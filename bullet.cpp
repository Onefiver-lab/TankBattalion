...
Bullet::Bullet(double x, double y, int direction, bool isFromPlayer, int shooterId, QObject *parent)
    : GameObject(x, y, 8, 8, parent), m_isFromPlayer(isFromPlayer), m_shooterId(shooterId)
{
